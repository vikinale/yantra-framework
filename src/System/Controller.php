...
abstract class Controller
{
    ...
    /**
     * Public accessor for the controller's current response object.
     * Used by Router to retrieve the response when controller methods return void.
     */
    ...
    {
        $token = (string)($this->request->input('_csrf') ?? '');
