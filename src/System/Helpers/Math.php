...
class Math
{
    ...
    {
        // eval() is extremely dangerous. For security reasons, this is disabled.
        // If you need expression evaluation, use a proper parser like `symfony/expression-language` or `mossadal/math-parser`.
        throw new \RuntimeException('Math::evaluate() is disabled for security reasons (eval usage).');
    }
